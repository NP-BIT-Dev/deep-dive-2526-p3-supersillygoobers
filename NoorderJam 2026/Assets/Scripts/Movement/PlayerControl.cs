...
public class PlayerControl : MonoBehaviour {
    ...
    void FixedUpdate() {
        ...
        if (hammerHead.GetComponent<Rigidbody2D>().Overlap(
                contactFilter, results) > 0)
        {
            ...
            body.GetComponent<Rigidbody2D>().linearVelocity = Vector2.ClampMagnitude(
                body.GetComponent<Rigidbody2D>().linearVelocity, 6);
        }
